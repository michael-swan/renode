...
Should Run Test1 Application
    ...
    Execute Command           gcov start @${CURDIR}/gcov/test1/addr2line-test1.elf
    Execute Command           emulation RunFor "0.007"

    Execute Command           gcov stop @${CURDIR}/gcov/test1/gcov_results_test1

    ${g}=  Run Process        gcov-10  gcov_results_test1.gc  -s  builds/git/renode-demo-sources/repositories/kendryte-standalone-sdk/src/test1  -t  cwd=${CURDIR}/gcov/test1
...
Should Run Test2 Application
    ...
    Execute Command           gcov start @${CURDIR}/gcov/test2/addr2line-test2.elf
    Execute Command           emulation RunFor "0.017"

    Execute Command           gcov stop @${CURDIR}/gcov/test2/gcov_results_test2

    ${g}=  Run Process        gcov-10  gcov_results_test2.gc  -s  builds/git/renode-demo-sources/repositories/kendryte-standalone-sdk/src/test2  -t  cwd=${CURDIR}/gcov/test2
